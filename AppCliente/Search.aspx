<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="AppCliente.Search" %>
           ...
           <div class="col-md-6 col-xs-12">
              <legend>Buscar Alumno</legend> 
               <input  runat="server" id="txtDni" name="txtDni" placeholder="Dni" class="form-control" required="" type="text">
                <!-- Button -->
                <br />
               <asp:Button class="btn btn-danger" ID="btnBuscar" runat="server" Text="Buscar" OnClick="btnBuscar_Click" />
                 <br />
            </div>
         </div>
       </div>
