<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListPackage.aspx.cs" Inherits="AppCliente.ListPackage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <br />
             ...
             <h1 align="center">Listado de Paquetes</h1>
             <div class="col-md-12 col-xs-12">
                <asp:GridView ID="GvPackage" runat="server" class="table table-striped text-centered">
                </asp:GridView>
            </div>
        </form>
         <br />
