<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPackage.aspx.cs" Inherits="AppCliente.AddPackage" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <!-- Form Name -->
        <legend><span class="glyphicon glyphicon-plane" aria-hidden="true"></span> Agregar Paquete Turistico</legend>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input runat="server" id="txtDescripcion" name="txtDescripcion" placeholder="Descripcion" class="form-control input-md" required="" type="text">
        ...
        <!-- Text input-->
        <div class="form-group">
          <label class="col-md-4 control-label" for="txtFechaSalida">Fecha de Salida:</label>  
          <div class="col-md-4">
          <input runat="server" id="txtFechaSalida" name="txtFechaSalida" placeholder="Fecha de Salida" class="form-control input-md" required="" type="text">
        ...
        <!-- Text input-->
        <div class="form-group">
          <label class="col-md-4 control-label" for="txtFechaLlegada">Fecha de Llegada:</label>  
          <div class="col-md-4">
          <input runat="server" id="txtFechaLlegada" name="txtFechaLlegada" placeholder="Fecha de Llegada" class="form-control input-md" required="" type="text">
        ...
        <!-- Text input-->
        <div class="form-group">
          <label class="col-md-4 control-label" for="txtCantidad">Cantidad de Plazas</label>  
          <div class="col-md-2">
          <input runat="server" id="txtCantidad" name="txtCantidad" placeholder=" Plazas" class="form-control input-md" required="" type="text">
    
          </div>
        </div>
        <!-- Text input-->
        <div class="form-group">
          <label class="col-md-4 control-label" for="txtImporte">Importe</label>  
          <div class="col-md-2">
          <input runat="server" id="txtImporte" name="txtImporte" placeholder="Importe" class="form-control input-md" required="" type="text">
